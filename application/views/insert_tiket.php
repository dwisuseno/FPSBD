                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="buatFilmBaru" method="post" action="<?php echo current_url(); ?>">
                                      <div class="form-group ">
                                          <label for="id" class="control-label col-lg-2">ID Movie</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="id" name="id" type="text" value="<?php echo isset($id) ? $id : set_value('id'); ?>" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                          ...
                          <button class="btn btn-danger" type="button">Second</button>
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-danger" type="submit" href="<?php echo base_url();?>admin/insert_movie">Create</button>
