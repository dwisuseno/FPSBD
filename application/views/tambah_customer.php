                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="tambah_customer" method="post" action="insert_customer">
                                      <div class="form-group ">
                                          <label for="ktp" class="control-label col-lg-2">KTP</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="ktp" name="ktp" type="text" value="<?php echo isset($id) ? $ktp : set_value('ktp'); ?>" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
