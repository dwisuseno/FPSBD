      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="border-head">
              <a type="button" class="btn btn-success" href="<?php echo base_url();?>admin/tambah_customer"><i class="fa fa-plus-circle"></i> Tambah Customer </a>
              <a type="button" class="btn btn-success" href="<?php echo base_url();?>admin/delete_customer"><i class="fa fa-minus-circle"></i> Delete Customer </a>
              <br></br>
            </div>
            <section class="panel">
