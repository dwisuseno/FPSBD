        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="border-head">
              <h3>Master Data Theatre</h3>
            </div>
            <div class="border-head">
              <a type="button" class="btn btn-success" href="<?php echo base_url();?>admin/tambah_teater"><i class="fa fa-plus-circle"></i> Tambah Data Theatre </a>
              <br></br>
            </div>
            <section class="panel">
