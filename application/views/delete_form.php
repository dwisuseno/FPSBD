                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="tambah_customer" method="post" action="<?php echo base_url();?>admin/delete">
                                      <div class="form-group ">
                                          <select name="movie" class="form-control">
                                                <?php foreach ($pilih as $pil) { ?>
                                                <option value="<?php echo $pil->ID_MOVIE; ?>"><?php echo $pil->JUDUL; ?></option>
                                                <?php } ?>
                                              </select>
                                      </div>
