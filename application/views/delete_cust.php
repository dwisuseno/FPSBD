                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="tambah_customer" method="post" action="<?php echo base_url();?>admin/hapus">
                                      <div class="form-group ">
                                          <select name="customer" class="form-control">
                                                <?php foreach ($pilih_customer as $pil) { ?>
                                                <option value="<?php echo $pil->ID_CUSTOMER; ?>"><?php echo $pil->NAMA; ?></option>
                                                <?php } ?>
                                              </select>
                                      </div>
